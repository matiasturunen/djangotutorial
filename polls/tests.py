...
class PollViewTests(TestCase):
    def test_index_view_with_no_polls(self):
        """
        if no polls exist, message should be shown
        """
    ...
    def test_index_with_two_past_polls(self):
        """
        the polls index page may contain multiple polls
        """
